...
import { ArrowLeftIcon, ChatBubbleLeftRightIcon, DocumentTextIcon, ClipboardDocumentListIcon, LightBulbIcon, BookmarkIcon, UserGroupIcon, AcademicCapIcon, BeakerIcon, BriefcaseIcon } from '@heroicons/react/24/outline';
import Header from '@/components/Layout/Header';

// Mock data - replace with actual data from your API
const cheatSheets = [
  { id: 1, title: 'Skills Development Framework', category: 'Development' },
  { id: 2, title: 'Team Enablement Guide', category: 'Teams' },
  { id: 3, title: 'Learning Pathways', category: 'Education' },
];

const templates = [
  { id: 1, title: 'Training Plan Template', category: 'Training' },
  { id: 2, title: 'Skills Assessment', category: 'Assessment' },
  { id: 3, title: 'Onboarding Checklist', category: 'Onboarding' },
];

const essentials = [
  { id: 1, title: 'Building Learning Culture', duration: '6 min' },
  { id: 2, title: 'Effective Team Development', duration: '7 min' },
  { id: 3, title: 'Skills Gap Analysis', duration: '5 min' },
];

const myNotes = [
  { id: 1, title: 'Team Training Notes', date: '2023-06-20' },
  { id: 2, title: 'Skills Development Plan', date: '2023-06-18' },
];

const aiUseCases = [
  {
    id: 1,
    title: 'Upskilling for AI Readiness',
    description: 'How a major corporation upskilled 10,000 employees in AI fundamentals.',
    category: 'Upskilling',
  ...
  },
  {
    ...
    description: 'Strategies for effectively enabling distributed teams with AI tools.',
  ...
  },
  {
    ...
    description: 'Creating clear career progression paths for AI and data science roles.',
  ...
  {
    id: 4,
    title: 'Learning & Development Innovation',
    description: 'Transforming corporate learning with AI-powered personalization.',
    category: 'L&D',
    icon: BeakerIcon,
...
const WorkforceEnablement = () => {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setChatMessages(prev => [...prev, { 
        sender: 'bot', 
        text: `I'm your AI assistant for Workforce Enablement. How can I help you with "${message}"?` 
      }]);
    }, 1000);
              ...
              {cheatSheets.map((item) => (
                <div key={item.id} className="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                  <div className="flex items-start">
                    <DocumentTextIcon className="h-6 w-6 text-teal-600 mt-0.5 mr-3 flex-shrink-0" />
                    <div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">Explore real-world applications of workforce enablement and development strategies.</p>
            </div>
            ...
            <div className="mt-8 bg-blue-50 rounded-xl p-6">
              ...
              <p className="text-gray-600 mb-4">Have an interesting workforce enablement use case to share? We'd love to hear about it!</p>
        ...
        return (
          <div className="flex flex-col h-[500px] bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500">Ask me anything about Workforce Enablement</p>
            </div>
            <div className="flex-1 p-4 overflow-y-auto space-y-4">
              {chatMessages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-8 text-gray-500">
                  <ChatBubbleLeftRightIcon className="h-12 w-12 text-gray-300 mb-4" />
                  <p>How can I help you with Workforce Enablement today?</p>
                </div>
              ) : (
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Workforce Enablement | AI Skills Toolkit</title>
        <meta name="description" content="Access essential resources for enabling your workforce with AI skills. Explore cheat sheets, templates, and expert guidance to build AI capabilities across your organization." />
      </Head>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-12">
          <div>
            ...
            <div className="mt-6">
              <h1 className="text-3xl font-bold text-gray-900">Workforce Enablement</h1>
              <p className="text-gray-600 mt-1">Resources and tools for enabling your workforce</p>
            </div>
          </div>
