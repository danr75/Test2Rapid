...
import { ArrowLeftIcon, ChatBubbleLeftRightIcon, DocumentTextIcon, ClipboardDocumentListIcon, LightBulbIcon, BookmarkIcon, BeakerIcon, ChartBarIcon } from '@heroicons/react/24/outline';
...
const aiUseCases = [
  {
    ...
    description: 'AI-powered predictive maintenance reduces downtime by 35% in automotive plants.',
  ...
  },
  {
    ...
    description: 'NLP models analyze customer feedback to improve product development cycles.',
  ...
  },
  {
    ...
    description: 'Machine learning models detect fraudulent transactions with 99.8% accuracy.',
    category: 'Security',
    icon: ChartBarIcon,
  ...
  },
  {
    ...
    description: 'AI-driven recommendations for employee upskilling based on skills gap analysis.',
    category: 'Education',
    icon: LightBulbIcon,
...
const DataTechCapable = () => {
      ...
      case 'usecases':
        return (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">AI Use Cases & Case Studies</h2>
              <p className="text-gray-600">Explore real-world applications of AI and data technologies across different industries.</p>
            </div>
            ...
            <div className="mt-8 bg-blue-50 rounded-xl p-6">
              ...
              <p className="text-gray-600 mb-4">Have an interesting AI or data technology use case to share? We'd love to hear about it!</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Data & Tech Capable | AI Skills Toolkit</title>
        <meta name="description" content="Access essential resources for developing data and technical AI capabilities. Explore cheat sheets, templates, and expert guidance to build and enhance your technical AI skills and infrastructure." />
      </Head>
