...
import { BookOpenIcon, CheckCircleIcon, LockClosedIcon, ArrowLeftIcon, ShieldCheckIcon, DocumentTextIcon, ScaleIcon, ChartBarIcon } from '@heroicons/react/24/outline';
  ...
  const [modules, setModules] = useState<Module[]>([
    {
      ...
      locked: false,
      content: [
        { type: 'text', content: 'Understanding AI Governance and Why It Matters' },
        ...
        { type: 'quiz', content: 'AI Governance Basics Quiz' }
      ]
    },
    {
      id: 'module-2',
      title: 'AI Risk Management',
      description: 'Identifying and mitigating risks in AI systems',
      duration: '20 min',
      completed: false,
      locked: false,
      content: [
        { type: 'text', content: 'Common AI Risks and Their Impacts' },
        { type: 'interactive', content: 'Risk Assessment Framework for AI' },
        { type: 'video', content: 'Case Studies in AI Risk Management' },
        { type: 'quiz', content: 'AI Risk Management Assessment' }
      ]
    },
    {
      id: 'module-3',
      title: 'AI Policy Development',
      description: 'Creating effective AI policies and procedures',
      duration: '25 min',
      completed: false,
      locked: true,
      content: [
        { type: 'text', content: 'Key Elements of AI Policy' },
        { type: 'video', content: 'Best Practices in AI Policy Development' },
        { type: 'interactive', content: 'Draft an AI Policy for Your Organization' }
      ]
    },
    {
      id: 'module-4',
      title: 'Compliance & Standards',
      description: 'Understanding AI regulations and industry standards',
      duration: '20 min',
      completed: false,
      locked: true,
      content: [
        { type: 'text', content: 'Global AI Regulations Overview' },
        { type: 'video', content: 'Implementing AI Standards in Your Organization' },
        { type: 'interactive', content: 'Compliance Checklist for AI Systems' },
        { type: 'quiz', content: 'AI Compliance Assessment' }
      ]
    }
  ]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta name="description" content="Master AI governance, policy, and risk management" />
      </Head>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-blue-100 max-w-2xl">
                  Develop robust governance frameworks and risk management strategies for responsible AI implementation
                </p>
              </div>
