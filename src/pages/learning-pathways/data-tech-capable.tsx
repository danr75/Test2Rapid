...
import { BookOpenIcon, CheckCircleIcon, LockClosedIcon, ArrowLeftIcon, CloudIcon, CpuChipIcon, CircleStackIcon, CodeBracketIcon } from '@heroicons/react/24/outline';
  ...
  const [modules, setModules] = useState<Module[]>([
    {
      ...
      description: 'Understanding data in the context of AI',
      duration: '20 min',
      completed: true,
      locked: false,
      content: [
        { type: 'text', content: 'Introduction to Data for AI' },
        { type: 'video', content: 'Data Quality and Management' },
        { type: 'interactive', content: 'Data Readiness Assessment' },
        { type: 'quiz', content: 'Data Fundamentals Quiz' }
      ]
    },
    {
      id: 'module-2',
      title: 'AI Technology Stack',
      description: 'Overview of AI technologies and platforms',
      duration: '25 min',
      completed: false,
      locked: false,
      content: [
        { type: 'text', content: 'AI Technology Landscape' },
        { type: 'interactive', content: 'Tech Stack Evaluation' },
        { type: 'video', content: 'Cloud AI Services Comparison' },
        { type: 'quiz', content: 'Tech Stack Knowledge Check' }
      ]
    },
    {
      id: 'module-3',
      title: 'AI Implementation',
      description: 'Practical approaches to implementing AI solutions',
      duration: '30 min',
      completed: false,
      locked: true,
      content: [
        { type: 'text', content: 'AI Project Lifecycle' },
        { type: 'video', content: 'Best Practices in AI Implementation' },
        { type: 'interactive', content: 'Implementation Planning Tool' }
      ]
    },
    {
      id: 'module-4',
      title: 'AI Operations',
      description: 'Managing and scaling AI in production',
      duration: '25 min',
      completed: false,
      locked: true,
      content: [
        { type: 'text', content: 'MLOps Fundamentals' },
        { type: 'video', content: 'Scaling AI Solutions' },
        { type: 'interactive', content: 'AI Operations Checklist' },
        { type: 'quiz', content: 'AI Operations Assessment' }
      ]
    }
  ]);
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-purple-100 max-w-2xl">
                  Develop the technical foundations and data capabilities needed for successful AI implementation
                </p>
              </div>
