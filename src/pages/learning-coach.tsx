    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {learningPathways.map((pathway) => {
                ...
                const handleCardClick = () => {
                  if (pathway.path) {
                    console.log(`Navigating to: ${pathway.path}`);
                    router.push(pathway.path);
                  } else {
                    console.warn(`No path defined for: ${pathway.title}`);
                  }
                };
          ...
          {/* My Toolkit Section */}
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">My Toolkit</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">AI Strategy Templates</h3>
                  </div>
                  <p className="text-gray-600 text-sm mb-4">Downloadable templates for AI strategy development and implementation planning.</p>
                  <button className="text-blue-600 hover:text-blue-800 text-sm font-medium">View Templates →</button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Ethics Assessment</h3>
                  </div>
                  <p className="text-gray-600 text-sm mb-4">Assess the ethical implications of your AI projects with our interactive tool.</p>
                  <button className="text-green-600 hover:text-green-800 text-sm font-medium">Start Assessment →</button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4">Curated list of books, articles, and courses for continuous learning.</p>
                  <button className="text-purple-600 hover:text-purple-800 text-sm font-medium">Explore Resources →</button>
                </div>
              </div>
            </div>
          </div>
